...
stdenv.mkDerivation rec {
  ...
  # https://forge.sourceware.org/mjw/valgrind/commits/branch/riscv64-linux
  src = fetchgit {
    url = "https://forge.sourceware.org/mjw/valgrind.git";
    rev = "44d6f35f2d6b48a875eb43304dc0f592728cdb35";
    sha256 = "sha256-dFXoR8pXf2HJn7JS/jpCEWKPlpImrXA++fEJucsfgLY=";
  };
  ...
  meta = {
    ...
    platforms = with lib.platforms; lib.intersectLists
      (x86 ++ power ++ s390x ++ armv7 ++ aarch64 ++ mips ++ riscv64)
